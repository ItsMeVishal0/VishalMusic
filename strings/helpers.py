...
• /anime <b>ǫᴜᴇʀʏ</b> : ꜱᴇᴀʀᴄʜ ᴍʏᴀɴɪᴍᴇʟɪꜱᴛ ꜰᴏʀ ᴛʜᴇ ɢɪᴠᴇɴ ǫᴜᴇʀʏ.
...
• /q <b>count</b> ➠ ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴍᴇꜱꜱᴀɢᴇ ᴡɪᴛʜ ᴀ ɴᴜᴍʙᴇʀ ᴛᴏ ǫᴜᴏᴛᴇ ᴛʜᴀᴛ ᴍᴇꜱꜱᴀɢᴇ ᴀɴᴅ ᴛʜᴇ ɴᴇxᴛ ᴍᴇꜱꜱᴀɢᴇꜱ ᴜᴘ ᴛᴏ 10.
• /q <b>count</b> r ➠ ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴍᴇꜱꜱᴀɢᴇ ᴡɪᴛʜ ᴀ ɴᴜᴍʙᴇʀ ᴀɴᴅ 'r' ᴛᴏ ǫᴜᴏᴛᴇ ᴛʜᴀᴛ ᴍᴇꜱꜱᴀɢᴇ, ɪᴛꜱ ʀᴇᴘʟɪᴇᴅ ᴍᴇꜱꜱᴀɢᴇ, ᴀɴᴅ ᴛʜᴇ ɴᴇxᴛ ᴍᴇꜱꜱᴀɢᴇꜱ ᴜᴘ ᴛᴏ 10.
